...
(double* pAMatrix, double* pBMatrix, int Size) {
...
(double* pAMatrix, double* pBMatrix,
	int Size) {
	int i, j;  // Loop variables 
...
(double* &pAMatrix, double* &pBMatrix,
	...
	if (ProcRank == 0) {
		...
		//Output the resul of initialization of MatrixA and MatrixB
		printf("\n*******************************************\n");
		printf("The resul of initialization of MatrixA\n");
		for (int i = 0; i < Size; i++) {
			printf("\n");
			for (int j = 0; j < Size; j++) {
				printf("%lf ", pAMatrix[i * Size + j]);
			}
		}
		printf("\n*******************************************\n");
...
void
DataDistribution
(double* pAMatrix, double* pBMatrix, double*
...
void
TestResult
(double* pAMatrix, double* pBMatrix, double* pCMatrix,
	int Size) {
	...
	if (ProcRank == 0) {
		...
		//Output the resul of serial algorithm
		printf("\n*******************************************\n");
